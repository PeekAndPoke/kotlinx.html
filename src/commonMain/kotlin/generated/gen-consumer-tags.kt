 ...
 */
@HtmlTagMarker
fun <T, C : TagConsumer<T>> C.picture(block : PICTURE.() -> Unit = {}) : T = PICTURE(emptyMap, this).visitAndFinalize(this, block)
 ...
 */
@HtmlTagMarker
fun <T, C : TagConsumer<T>> C.summary(classes : String? = null, block : SUMMARY.() -> Unit = {}) : T = SUMMARY(attributesMapOf("class", classes), this).visitAndFinalize(this, block)

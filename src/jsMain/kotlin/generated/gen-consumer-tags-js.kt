 ...
 */
@HtmlTagMarker
public fun TagConsumer<HTMLElement>.picture(block : PICTURE.() -> Unit = {}) : HTMLPictureElement = PICTURE(emptyMap, this).visitAndFinalize(this, block) as HTMLPictureElement
 ...
 */
@HtmlTagMarker
public fun TagConsumer<HTMLElement>.summary(classes : String? = null, block : SUMMARY.() -> Unit = {}) : HTMLElement = SUMMARY(attributesMapOf("class", classes), this).visitAndFinalize(this, block)
